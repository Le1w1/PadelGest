namespace UI
{
    partial class frmRepararIntegridad
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvInconsistencias.ForeColor = Color.FromArgb(18, 18, 18);
            ...
            dgvInconsistencias.RowsDefaultCellStyle.BackColor = Color.White;
            dgvInconsistencias.RowsDefaultCellStyle.ForeColor = Color.FromArgb(18, 18, 18);
            dgvInconsistencias.RowsDefaultCellStyle.SelectionBackColor = Color.FromArgb(211, 230, 248);
            dgvInconsistencias.RowsDefaultCellStyle.SelectionForeColor = Color.FromArgb(18, 18, 18);
            dgvInconsistencias.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(244, 247, 251);
            dgvInconsistencias.AlternatingRowsDefaultCellStyle.ForeColor = Color.FromArgb(18, 18, 18);
            dgvInconsistencias.AlternatingRowsDefaultCellStyle.SelectionBackColor = Color.FromArgb(211, 230, 248);
            dgvInconsistencias.AlternatingRowsDefaultCellStyle.SelectionForeColor = Color.FromArgb(18, 18, 18);
